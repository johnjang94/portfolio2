...
export default function OtherMenu() {
  return (
    <div className="md:flex md:items-center md:space-x-40 justify-center space-y-10 md:space-y-0 mx-8 md:mx-0">
      <Link to="/">
        <div className="flex items-center p-5 rounded-2xl gap-2 text-blue-500 bg-transparent hover:bg-gradient-to-br hover:from-blue-400 hover:to-transparent transition-all duration-2000 ease-in-out">
          <button>
            <HiMiniArrowLongLeft />
          </button>
